...
class Game(base.Module):
    def __init__(self, handler):
        ...
        # text box that displays the current word to type
        ...
        # make text boxes that represent players
        for i in range(0,4):
    ...
    def notify(self, event):
        if isinstance(event, events.StartGame):
            ...
            self.handler.post_event(events.EndGame) # porgram is listening for GameEnded event
